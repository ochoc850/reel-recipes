...
async function generateRecipe() {
  ...
  const message = await client.messages.create({
    ...
    messages: [{
      role: "user",
      content: `You are adding a new recipe to a film recipe website called Reel Recipes.

Generate ONE new recipe object for a famous food moment from a well-known film. Alternate between animated and live-action films. Be historically and culturally accurate.
